...
links:
  - group: 国内论坛  
    links:
      ...
      - title: MCmod
        ...
        description: 中文 Minecraft 模组百科 涵盖模组、物品、教程与版本资料
        tags: [mods, community]
      - title: MC地图网
        url: https://www.mcmaps.cn
        description: 中文 Minecraft 地图资源站 为服主提供地图存档与教程
        tags: [maps, community]
      - title: Minebbs
        url: https://minebbs.com/
        description: 中文 Minecraft 综合社区论坛 涵盖服务端与插件资源
        tags: [forum, community]
      - title: PixelBBS
        url: https://www.pixelbbs.cn
        description: 中文 Minecraft 资源与交流论坛 面向服主与玩家
        tags: [forum, community]
      - title: Teacon
        url: https://www.teacon.cn/
        description: 中文 Minecraft 模组开发茶会 主办线上模组开发黑客松
      ...
      - title: 红石中继器
        ...
        description: 中文 Minecraft 资源站 提供综合资源下载与交流
        tags: [community]
      - title: 网易我的世界论坛
        url: https://mc.netease.com/
        description: 网易我的世界中国版官方社区论坛
        tags: [forum, community]
      - title: 苦力怕论坛
  ...
  - group: 国外论坛
    links:
      - title: Curseforge
        url: https://minecraft.curseforge.com/
        description: 老牌 Minecraft 模组、整合包与插件资源平台
        tags: [mods, plugins, community]
      - title: Minecraft Forum
        url: https://www.minecraftforum.net/
        description: 老牌 Minecraft 英文综合论坛 涵盖讨论与资源分享
        tags: [forum, community]
      - title: Modrinth
        url: https://modrinth.com/plugins
        description: 开源的 Minecraft 模组与插件分发平台
        tags: [plugins, mods, community]
      - title: Planet Minecraft
        url: https://www.planetminecraft.com/
        description: Minecraft 创意资源社区 分享地图、皮肤、材质与服务器
        tags: [community, maps, skins]
      - title: SpigotMC
        url: https://www.spigotmc.org/
        description: Spigot/Bukkit 插件开发与发布的官方社区论坛
        tags: [forum, community, spigot]
---
      - title: HiMCBBS论坛
        url: https://www.himcbbs.com/
        description: MCBBS 关停后兴起的中文 Minecraft 论坛社区
        tags: [forum, community]